...
public class jdRep_boleta_informativa extends javax.swing.JDialog {
    
    Reporte objR = new Reporte();

    public jdRep_boleta_informativa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnVerReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerReporteActionPerformed
        try {
            ...
            JRViewer objReporte = objR.reporteInterno("boleta_informativa.jasper", null);
