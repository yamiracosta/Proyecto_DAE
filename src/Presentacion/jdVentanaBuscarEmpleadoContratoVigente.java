 ...
 * @author jefer
 */
public class jdVentanaBuscarEmpleadoContratoVigente extends javax.swing.JDialog {
    ...
    public jdVentanaBuscarEmpleadoContratoVigente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void txtNumDocEmpleadoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNumDocEmpleadoKeyReleased
        try {
            ...
            Logger.getLogger(jdVentanaBuscarEmpleadoContratoVigente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static Image obtenerImagen() {
        ...
        Image icono = null;
        try {
            icono = new ImageIcon(jdVentanaBuscarEmpleadoContratoVigente.class.getResource("/Recursos/btn_buscar_empleado.png")).getImage();
        } catch (Exception e) {
