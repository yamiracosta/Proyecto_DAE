 ...
 * @author jefer
 */
public class jdVentanaBuscarEmpleadoContratoVigente_AnularContrato extends javax.swing.JDialog {
    ...
    public jdVentanaBuscarEmpleadoContratoVigente_AnularContrato(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtNumDocEmpleado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNumDocEmpleadoActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtNumDocEmpleado, javax.swing.GroupLayout.DEFAULT_SIZE, 854, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void txtNumDocEmpleadoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNumDocEmpleadoKeyReleased
        try {
            ...
            Logger.getLogger(jdVentanaBuscarEmpleadoContratoVigente_AnularContrato.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        try {
            ...
            if (tblEmpleados.getRowCount() == 0) {
                JOptionPane.showMessageDialog(rootPane, "No existen empleados con contrato vigente");
                this.dispose();
            }
        } catch (Exception ex) {
            Logger.getLogger(jdVentanaBuscarEmpleadoContratoVigente_AnularContrato.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void txtNumDocEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNumDocEmpleadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNumDocEmpleadoActionPerformed
    ...
    public static Image obtenerImagen() {
        ...
        Image icono = null;
        try {
            icono = new ImageIcon(jdVentanaBuscarEmpleadoContratoVigente_AnularContrato.class.getResource("/Recursos/btn_buscar_empleado.png")).getImage();
        } catch (Exception e) {
